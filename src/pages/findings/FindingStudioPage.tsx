...
const StudioHeader = ({ 
  ...
  >
    ...
    <div className="flex items-center gap-3">
      ...
      {mode === 'zen' && (
        <button className="p-2 text-slate-400 hover:text-slate-600" title="Tam Ekran">
          <Maximize2 size={18} />
        </button>
      )}
  ...
  if (mode === 'zen') {
    return (
      <div className={cn(
        ...
        <StudioHeader 
          title={finding.title} id={finding.id} mode={mode} setMode={setMode} 
          isVetoed={isVetoed} navigate={navigate} 
        />
