...
export default function FindingStudioPhase4Page({ findingId, onNextPhase }: Phase4Props) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-blue-50/30 font-sans pb-24">
          ...
          <div className={clsx("transition-all duration-500", allPlansEvaluated ? "opacity-100" : "opacity-50 pointer-events-none grayscale")}>
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden mt-8">
                  ...
                  <div className="p-6">
                      ...
                      {/* SONRAKİ AŞAMA BUTONU (Kapanış) */}
                      <button 
                          onClick={onNextPhase}
                          className="w-full mt-6 py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 shadow-lg flex items-center justify-center gap-2 transition-transform active:scale-95"
                      >
