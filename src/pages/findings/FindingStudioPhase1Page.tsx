  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-blue-800/80 text-xs mt-1">
            Bulgu şu an taslak halindedir. İçeriği kontrol edin, gizli notlarınızı ekleyin ve hazır olduğunda yönetici onayına gönderin.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* SOL: Finding Paper (Kağıt Görünümü) */}
        <div className="lg:col-span-2 space-y-6">
          <FindingPaper finding={finding} />
        </div>

        {/* SAĞ: Denetçi Araçları */}
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm sticky top-24">
            ...
            <div className="space-y-3">
              <button 
                onClick={() => navigate(`/execution/findings/${finding.id}`)} // Form moduna git
